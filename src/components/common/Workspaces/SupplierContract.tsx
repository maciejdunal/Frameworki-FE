    ...
    return (
        <Wrapper>
            ...
            <LatestUpdates>
                ...
                <LatestUpdatesMedia style={{backgroundColor:'#F5F7F9'}}>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={allWS} alt={allWS}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={sasWS} alt={sasWS}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={sarlWS} alt={sarlWS}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={secondary} alt={secondary}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={communitiesWS} alt={communitiesWS}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={poaWS} alt={poaWS}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={surveyWS} alt={surveyWS}/>
                    <img style={{height:'30px' ,marginLeft:'17px', borderRadius:'5px', border: '2px solid #d8dbe1'}} src={threedots} alt={threedots}/>

                </LatestUpdatesMedia>

                <LatestUpdatesContent style={{backgroundColor:'#F5F7F9'}}>
                    <PaginateWS/>
